...
class DoTPFN(nn.Module):
    ...
    """
    def __init__(self, tab_embed_dim, doc_input_dim=128, d_model=256, num_heads=4, dropout=0.2):
        super().__init__()
...
class ClinicalMultimodalPipeline:
    def __init__(self, feature_cols, device, model_save_dir):
...
if __name__ == "__main__":
    ...
    MODEL_SAVE_DIR = "/home/yhchoi/PSG_DocParse_260501/exp_mm_260511"
    LOG_SAVE_PATH = "/home/yhchoi/PSG_DocParse_260501/exp_mm_260511/logs/results.csv"
    
    # 1. Feature Defs (Full list from original extraction script)
    feature_cols = [
        'kubyeo', 'fu_duration', 'Date', 'SEX', 'AGE', 'Height', 'Weight', 'BMI', 
